...
describe('GET /api/articles', () => {
  ...
  const testArticlesData = [
    ...
    },
    {
      ...
      ogImageUrl: 'https://res.cloudinary.com/zenn/image/upload/og.png',
  ...
  describe('正常系', () => {
    ...
    it('ogImageUrl を含めて返し、画像が無い記事は null を返す', async () => {
      ...
      expect(zennArticle?.ogImageUrl).toBe('https://res.cloudinary.com/zenn/image/upload/og.png')
      expect(qiitaArticle?.ogImageUrl).toBeNull()
    })
